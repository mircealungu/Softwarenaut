@echo off
echo Starting Java2MSE Multiple Projects Exporter...
@echo off
...
"%JAVA_HOME%\bin\java"  -Dsun.java2d.noddraw=true -Xms256m -Xmx1024m -classpath %LOCALCLASSPATH% com.intooitus.infusion.util.MJava2MSE %1 %2 
