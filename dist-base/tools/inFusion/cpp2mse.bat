@echo off
echo Starting Cpp2MSE Exporter...
@echo off
...
"%JAVA_HOME%\bin\java"  -Dsun.java2d.noddraw=true -Xms256m -Xmx1024m -classpath %LOCALCLASSPATH% com.intooitus.infusion.util.Cpp2MSE %1 %2 %3
